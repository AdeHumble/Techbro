...
Areas i wish to improve on this program
    1. For the program to be able to ask HOW MANY QUESTIONS will the user want to answer & to exactly work with this
    2. For the program to randomly picks questions
    3. Plot a simple graph or a table to demonstrate the quiz result instead of in %
    4. GUI enabled
"""    
